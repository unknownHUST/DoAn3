        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                    	<div class="row">
                    		<c:set var="sanphamcurrent" value="${sanphamCurrent}"></c:set>
                            <div class="col-lg-6">
                                <form action="/Miniproject/admin/products/updatesp" method="post" class="form-horizontal">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                    		<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Mã sản phẩm</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="masp" name="masp" value="${sanphamcurrent.getIdSanPham()}" readonly="readonly" placeholder="Nhập tên sản phẩm..." class="form-control">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="madanhmuc" id="madanhmuc" class="form-control">
                                                    	<c:forEach var="danhmuc" items="${listdanhmuc}">
		                                                        <option <c:if test="${danhmuc.getIdDanhMucSanPham() == sanphamcurrent.getDanhMucSanPham().getIdDanhMucSanPham()}">selected="selected"</c:if> value="${danhmuc.getIdDanhMucSanPham()}">${danhmuc.getTenDanhMuc()}</option>
                                                    	</c:forEach>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="tensanpham" name="tensanpham" value="${sanphamcurrent.getTenSanPham()}" placeholder="Nhập tên sản phẩm..." class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="giasanpham" name="giasanpham" value="${sanphamcurrent.getGiatien()}" placeholder="Nhập giá sản phẩm..." class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="gioitinh" id="gioitinh" class="form-control">
                                                        <option <c:if test="${"all".equals(sanphamcurrent.getGioitinh()) }">selected="selected"</c:if> value="all">All</option>
                                                        <option <c:if test="${"male".equals(sanphamcurrent.getGioitinh()) }">selected="selected"</c:if> value="male">Nam</option>
                                                        <option <c:if test="${"female".equals(sanphamcurrent.getGioitinh()) }">selected="selected"</c:if> value="female">Nữ</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="motasanpham" id="motasanpham" rows="5" placeholder="Content..." class="form-control">${sanphamcurrent.getMotaSP()}</textarea>
                                                </div>
                                            </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div id="container_chitiet" class="card">
                                    <div class="card-header">
                                        <strong>Chi tiết size và số lượng</strong>
                                    </div>
                                    <c:forEach var="chitietspcurrent" items="${listctsp}">
                                    <div class="card-body card-block chitietsanpham">
                                    	<div class="row form-group machitiet">
											<div class="col col-md-3">
												<label for="text-input" class=" form-control-label">Mã chi tiết</label>
											</div>
											<div class="col-12 col-md-9">
												<input type="number" id="mact" name="mact" readonly="readonly" value="${chitietspcurrent.getIdChiTietSanPham()}"
												    class="form-control">
										...
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<select name="masize" id="masize" disabled="disabled" class="form-control">
													<c:forEach var="sizesp" items="${listsizesp}">
													<option <c:if test="${sizesp.getIdSizeSanPham() == chitietspcurrent.getSizeSanPham().getIdSizeSanPham() }">selected="selected"</c:if> value="${sizesp.getIdSizeSanPham()}">Size ${sizesp.getTenSize()}</option>
													</c:forEach>
												</select>
											</div>
										</div>
										<div class="row form-group">
											...
											<div class="col-12 col-md-9">
												<input type="number" id="soluong" name="soluong" min="1" value="${chitietspcurrent.getSoluong()}"
													class="form-control">
	
											</div>
										</div>
										<div class="row form-group">
											<a href="/Miniproject/admin/products/deletectsp/${chitietspcurrent.getIdChiTietSanPham()}" type="button" class="btn btn-danger btn-sm">Delete</a>
										</div>
										<hr>
                                	</div>
                                    </c:forEach>
                                ...
                                <div id="themchitiet" class="card-body card-block chitietsanpham">
                                	<form action="/Miniproject/admin/products/addctsp/${sanphamcurrent.getIdSanPham()}/" method="get">
									<div class="row form-group">
										<div class="col col-md-3">
											<label for="select" class=" form-control-label">Size</label>
										</div>
										<div class="col-12 col-md-9">
											<select name="masize" id="masize" class="form-control">
												<c:forEach var="sizesp" items="${listsizesp}">
												<option value="${sizesp.getIdSizeSanPham()}">Size ${sizesp.getTenSize()}</option>
												</c:forEach>
											</select>
										</div>
									</div>
									...
									<div class="row form-group">
										<button type="submit" class="btn btn-primary btn-sm" style="margin-left: 90%;">+Add</button>
									</div>
                                	</form>
									<hr>
                                </div>
                                ...
                                <div class="table-data__tool-right">
                                    <button id="btnthemchitiet" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>thêm chi tiết</button>
                                    <br>
                                </div>
