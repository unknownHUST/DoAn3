                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                    	<form action="/Miniproject/admin/products" method="post">
	                                        <div class="rs-select2--light rs-select2--md">
	                                            <select class="js-select2" name="iddanhmuc">
	                                                <option selected="selected" value="0">All</option>
	                                                <c:forEach var="danhmuc" items="${listdmsp}">
	                                        ...
	                                        <div class="rs-select2--light rs-select2--sm">
	                                            <select class="js-select2" name="gioitinh">
	                                                <option selected="selected" value="all,male,female">Giới tính</option>
	                                                <option value="male,female,all">All</option>
	                                                <option value="male,all">Nam</option>
	                                                <option value="female,all">Nữ</option>
	                                            </select>
	                                            <div class="dropDownSelect2"></div>
	                                        </div>
                                    ...
                                    <div class="table-data__tool-right">
                                        <a href="/Miniproject/admin/products/addproduct" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>add item</a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <c:forEach var="sanpham" items="${listsp}">
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <span class="block-email">${sanpham.getTenSanPham()}</span>
                                                </td>
                                                <td class="desc">${sanpham.getMotaSP()}</td>
                                                <td>${sanpham.getGioitinh()}</td>
                                                <td>${sanpham.getGiatien()} vnđ</td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="/Miniproject/admin/products/update/${sanpham.getIdSanPham()}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </a>
                                                        <a href="/Miniproject/admin/products/delete/${sanpham.getIdSanPham()}" class="item" data-toggle="tooltip" data-placement="top" title="Delete">
