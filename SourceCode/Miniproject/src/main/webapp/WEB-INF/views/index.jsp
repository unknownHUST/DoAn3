...
<body>
	...
	<div class="site-wrap">
		...
		<div class="site-blocks-cover"
			style="background-image: url('<c:url value="/resources/images/background_header.jpg"/>');" data-aos="fade">
			<div class="container">
				<div
					class="row align-items-start align-items-md-center justify-content-end">
					<div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
						<h1 style="color: black;" class="mb-2">Finding Your Perfect Shoes</h1>
						<div class="intro-text text-center text-md-left">
							<!-- <p style="color: #7971ea;" class="mb-4">Lorem ipsum dolor sit amet, consectetur
					...
					<div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4"
						...
						<div class="text">
							...
							<p>Giao hàng nhanh chóng.
								Miễn phí giao hàng trong nội thành Hà Nội.</p>
						</div>
					</div>
					<div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4"
						...
						<div class="text">
							...
							<p>Hoàn trả miễn phí trong 3 ngày đầu hoặc sản phẩm lỗi.
								Hỗ trợ đổi sản phẩm mới.</p>
						</div>
					</div>
					<div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4"
						...
						<div class="text">
							...
							<p>Đội ngũ chăm sóc khách hàng nhiệt tình.
								Hộ trợ online từ 9h sáng đến 9h tối các ngày trong tuần và từ 10h sáng đến 6h tối ngày cuối tuần.</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0"
						...
						<a class="block-2-item" href="/Miniproject/shop/2?page=1">
							<figure class="image">
								<img src='<c:url value="/resources/images/women.jpg"/>' alt="" class="img-fluid">
							</figure>
							<div class="text">
								<h3>Women</h3>
							</div>
					...
					<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0"
						...
						<a class="block-2-item" href="#">
							<figure class="image">
								<img src='<c:url value="/resources/images/children.jpg"/>' alt="" class="img-fluid">
							</figure>
							<div class="text">
								<h3>Children</h3>
							</div>
					...
					<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0"
						...
						<a class="block-2-item" href="/Miniproject/shop/1?page=1">
							<figure class="image">
								<img src='<c:url value="/resources/images/men.jpg"/>' alt="" class="img-fluid">
							</figure>
							<div class="text">
								<h3>Men</h3>
							</div>
			...
			<div class="container">
				...
				<div class="row align-items-center">
					<div class="col-md-12 col-lg-7 mb-5">
						<a href="#"><img src='<c:url value="/resources/images/blog_1.jpg"/>'
					...
					<div class="col-md-12 col-lg-5 text-center pl-md-5">
						...
						<p>
							<a href="/Miniproject/shop" class="btn btn-primary btn-sm">Shop Now</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
						...
						<a href="#" class="block-6"> <img src='<c:url value="/resources/images/hero_1.jpg"/>'
