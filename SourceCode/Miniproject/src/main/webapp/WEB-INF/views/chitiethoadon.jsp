                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            	<td>${ctsp.getChiTietSanPham().getSanPham().getIdSanPham()}</td>
                                                <td>${ctsp.getChiTietSanPham().getSanPham().getTenSanPham()}</td>
                                                <td>${ctsp.getChiTietSanPham().getSizeSanPham().getTenSize()}</td>
                                                <td>${ctsp.getSoluongmua()}</td>
                                            </tr>
                                        	</c:forEach>
                                        </tbody>
                                    </table>
